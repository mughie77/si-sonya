        ...
        <?php else: ?>
            ...
            <div class="card-zen p-10 flex flex-col items-center text-center">
                 <div class="relative mb-6">
                    ...
                    <div class="absolute -bottom-2 -right-2 bg-indigo-600 text-white w-10 h-10 rounded-full border-4 border-white flex items-center justify-center font-bold text-xs shadow-lg">
                        75%
                    </div>
                 </div>
