...
<body class="bg-gray-50 min-h-screen">
    ...
    <main class="max-w-3xl mx-auto p-6 md:p-10 space-y-8 pb-32">
        ...
        <div class="bg-white rounded-[40px] p-10 md:p-16 shadow-sm border border-gray-100 text-center">
            <div class="inline-block p-6 bg-purple-50 text-purple-600 rounded-[30px] mb-8 shadow-inner">
            ...
            <div class="mt-12 pt-12 border-t border-gray-50">
                <p class="text-[9px] text-gray-400 font-black tracking-widest uppercase italic">"Setiap masukan akan ditinjau secara berkala oleh tim manajemen sekolah."</p>
            </div>
        </div>
    </main>
