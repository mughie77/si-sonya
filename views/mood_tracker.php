                ...
                <form action="" method="POST" class="space-y-10">
                    ...
                    <div class="grid grid-cols-2 sm:grid-cols-3 gap-4 md:gap-6">
                        <label class="cursor-pointer">
                            ...
                            <div class="mood-box p-6 border-2 border-gray-50 rounded-3xl text-center shadow-sm hover:shadow-md">
                    ...
                    <button type="submit"
                        class="w-full bg-blue-600 hover:bg-blue-700 text-white font-black py-5 rounded-[30px] shadow-xl shadow-indigo-100 transition-all transform active:scale-95 uppercase tracking-widest text-xs">
                        Simpan Perasaan
                    </button>
                </form>
            </div>
