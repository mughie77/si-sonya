        ...
        <div class="grid md:grid-cols-2 gap-8">
            ...
            <div class="bg-indigo-900 rounded-[40px] p-10 shadow-xl text-white">
                ...
                <div class="space-y-4 text-xs font-medium text-indigo-100 leading-relaxed">
                    ...
                    <div class="mt-6 p-4 bg-white/10 rounded-2xl italic border border-white/10">
                        "Jika kolom password dikosongkan, sistem akan menggunakan NIS/NIP sebagai kata sandi default."
                    </div>
                </div>
            </div>
        </div>
