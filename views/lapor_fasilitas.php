                    ...
                    <form action="" method="POST" enctype="multipart/form-data" class="space-y-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="nama_fasilitas" required placeholder="Contoh: AC Ruang Guru, Kursi Kantin"
                                class="w-full px-6 py-4 rounded-[25px] bg-gray-50 border-none focus:ring-2 focus:ring-blue-100 outline-none transition duration-200 text-sm">
                        </div>
                        <div>
                            ...
                            <textarea name="deskripsi" required rows="4" placeholder="Jelaskan detail kerusakan yang Anda temui..."
                                class="w-full px-6 py-4 rounded-[25px] bg-gray-50 border-none focus:ring-2 focus:ring-blue-100 outline-none transition duration-200 text-sm"></textarea>
                        </div>
                        <div>
                    ...
                    <div class="space-y-4 max-h-[600px] overflow-y-auto pr-2 custom-scrollbar">
                        ...
                        <?php foreach ($riwayat as $r): ?>
                            <div class="p-6 border border-gray-50 rounded-[30px] bg-gray-50/50 flex items-center gap-6 group hover:bg-white hover:border-blue-100 transition shadow-sm">
                                <div class="w-16 h-16 bg-white rounded-2xl flex-shrink-0 flex items-center justify-center text-indigo-600 font-bold overflow-hidden shadow-sm text-xl">
